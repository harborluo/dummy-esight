...
public class RaidCardController extends BaseController {
	...
	@RequestMapping(method= RequestMethod.GET, path = "/redfish/v1/rich/Nodes/{{nodeId}}/Storage/RaidCard")
    public @ResponseBody
	...
	@RequestMapping(method= RequestMethod.GET, path = "/redfish/v1/rich/Nodes/{{nodeId}}/Storage/RaidCard/{raidId}")
    public @ResponseBody
